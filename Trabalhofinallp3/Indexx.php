...
<html lang="pt">
<head>
  <title>Dress Out - Roupas e Acessórios:</title>
  <meta charset="utf-8">
...
echo "Bem Vindo(a) ".$_SESSION['nome']."<a href='logout.php'>Logout</a>";
else
echo "<a href ='login.php'>Clique aqui para login</a>";
?>

<div class="container-fluid">
	 <h2>Quem somos?</h2>
  <h4>Dress Out é uma loja online que oferece o melhor para os nossos clientes, onde podemos atender todas as expectativas sobre a moda feminina sempre 
  de olho nas tendências e lançamentos.
...
com os melhores preços aliado a um ótimo atendimento a você cliente, que é a pessoa mais importante para nós.</h4><br>
